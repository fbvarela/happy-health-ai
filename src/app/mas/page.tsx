...
const settings = [
  ...
  { label: "Mi perfil", detail: "Datos personales y preferencias", icon: UserRound, href: "/profile" },
  { label: "Umbrales de alerta", detail: "Valores de referencia por paciente", icon: Settings, href: "/settings" },
